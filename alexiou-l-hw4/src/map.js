import { currentParkId } from "./main.js"
// I. Variables & constants
const accessToken = "pk.eyJ1Ijoibm8tbHVjayIsImEiOiJjbGdhMmF6ZWUwa3h1M3VwY3hkZ3NnYjg1In0.lnNacBxllCuK5iKPUdGZrg";
let map;
...
const initMap = (center) => {
	...
	//map.addEventListener("click", experiment)
...
const addMarkersToMap = (json, clickHandler) => {
	...
	//loop through the features array and for each one add a market to the map
...
const addMarker = (feature, className, clickHandler) => {
	// A. Create a map maker using feature (i.e. "Park") data
	// - the marker is a <div>
	...
	// https://docs.mapbox.come/mapbox-gl-js/api/markers/#marker
	// https://docs.mapbox.come/mapbox-gl-js/api/markers/#popup
	const marker = new mapboxgl.Marker(el)
		.setLngLat(feature.geometry.coordinates)
		.setPopup(new mapboxgl.Popup({ offset: 10, closeOnClick: true})
		.setHTML(html))
		.addTo(map);
