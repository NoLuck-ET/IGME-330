...
const setupCanvas = (canvasElement,analyserNodeRef) => {
	...
	gradient = utils.getLinearGradient(ctx,0,0,0,canvasHeight,[{percent:0.25,color:"darkblue"},{percent:0.5,color:"blue"},{percent:0.75,color:"magenta"}, {percent:1,color:"darkmagenta"}]);
